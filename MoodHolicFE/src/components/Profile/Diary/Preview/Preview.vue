    ...
    <section class="inner">
      <div class="frame-parent">
        <div class="rectangle-parent">
          ...
          <div class="my-mood-label-parent">
            <div class="my-mood-label">
              <div class="div3">4월 5일 금요일</div>
            </div>
            <div class="frame-group">
              <div class="frame-container">
                <div class="month-day-label-wrapper">
                ...
                <input
                    class="frame-inner"
                    placeholder="오늘 내 기분을 말하자면 마이쮸같았지 "
                    type="text"
                />
              </div>
              <div class="frame-div">
                ...
                <div class="rectangle-group">
                  ...
                  <div class="div6">
                    ...
                    다썼다. 강의실이 너무 추워서 심장이 마이쮸같이 쫄깃 쫄깃
                    해지는 것 같다. 반팔입은 사람들은 안 추운걸꽈,,,? 집에는
                    언제 가쥐? 내일은 이사가는 날이라 집가서 짐을 싸야할 것
                    같다.
                  </div>
                </div>
              </div>
          ...
          <div class="frame-parent1">
            ...
            <div class="rectangle-parent1">
              ...
              <div class="group-parent">
                <img class="group-icon2" alt="" src="@/assets/icon/Profile/Diary/Preview/singer.png" />
            ...
            <div class="rectangle-parent3">
                ...
                <div class="frame-parent6">
                  <div class="frame-wrapper4">
                    <div class="rectangle-parent4">
                      ...
                      <div class="div12">음식</div>
                    </div>
                  </div>
                  <div class="frame-parent7">
                    <div class="d-e-a-n-label-wrapper">
                      <img
                          class="d-e-a-n-label"
                          alt=""
              ...
              <div class="frame-wrapper5">
                <div class="frame-parent9">
                  <div class="drama-label-wrapper">
                    <img
                        class="drama-label-icon"
                        alt=""
                        src="@/assets/icon/Profile/Diary/Preview/category.png"
                    />
                  </div>
                  <div class="div15">한식</div>
                </div>
              </div>
            </div>
          </div>
