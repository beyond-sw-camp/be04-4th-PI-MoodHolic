...
<script setup>
import {ref} from 'vue';
import happyImg from '@/components/common/calendar/img0.png';
import sadImg from '@/components/common/calendar/img1.png';
import sosoImg from '@/components/common/calendar/img2.png';
