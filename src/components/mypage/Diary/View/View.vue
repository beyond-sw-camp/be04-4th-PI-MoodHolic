    ...
    <section class="ai-inner">
      <div class="rectangle-parent">
        ...
        <div class="frame-parent">
          <div class="frame-group">
            <header class="frame-container">
              <div class="frame-wrapper">
                <div class="ai-pick-parent">
                  <div class="ai-pick">AI Pick</div>
                  <section class="vector-wrapper">
                    <img
                        class="vector-icon"
                        alt=""
          ...
          <div class="sentiment-analysis-a-i">
            <div class="sentiment-analysis-a-i-child"></div>
            <div class="sentiment-analysis-a-i-inner">
              <div class="group">
                <img
                    class="icon2"
                    loading="lazy"
            ...
            <div class="classroom">
              <div class="div8">
                <p class="p">
                  ...
                  시간을다썼다.  강의실이 너무 추워서 심장이 마이쮸같이 쫄깃
                  쫄깃 해지는 것 같다.
                </p>
                <p class="p1">
                  반팔 입은 사람들은 안 추운걸꽈,,,? 집에는 언제 가쥐? 내일은
                  이사가는 날이라 집가서짐을 싸야할 것 같다.
                </p>
              </div>
            </div>
          </div>
