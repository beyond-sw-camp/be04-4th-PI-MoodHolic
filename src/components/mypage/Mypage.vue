...
.konan-wrapper {
  ...
  align-items: flex-start;
  justify-content: flex-start;
  padding: 0 var(--padding-56xl) 0 var(--padding-52xl);
}
.h2 {
  margin: 0;
  align-self: stretch;
...
.vector-parent {
  ...
  flex-direction: column;
  padding: 15.2px var(--padding-22xl) var(--padding-xl-6) var(--padding-26xl);
  gap: var(--gap-base-6);
}
.rectangle-icon {
  width: 141px;
...
.vector-container {
  flex-direction: row;
  padding: 0 var(--padding-xl) 0 var(--padding-xs-5);
}
.frame-parent1,
.vector-container,
.vector-group {
...
.vector-group {
  ...
  background-color: var(--color-whitesmoke);
  flex-direction: column;
  padding: 15.2px var(--padding-7xl) var(--padding-xl-6) var(--padding-13xl-5);
  gap: var(--gap-xl-8);
}
.frame-parent1 {
  align-self: stretch;
...
.vector-parent1 {
  ...
  align-items: flex-start;
  justify-content: flex-start;
  padding: 0 var(--padding-10xs) 0 var(--padding-9xs-2);
}
.vector-parent1 {
  flex: 1;
  border-radius: var(--br-mini);
  background-color: var(--color-whitesmoke);
  flex-direction: column;
  padding: var(--padding-sm-9) var(--padding-xl) var(--padding-3xl-9)
  var(--padding-21xl);
  box-sizing: border-box;
  gap: var(--gap-sm-5);
  min-width: 106px;
...
.group-container {
  ...
  align-items: flex-start;
  justify-content: flex-start;
  padding: 0 var(--padding-2xl) 0 15.1px;
}
.vector-parent2 {
  flex: 1;
  border-radius: var(--br-mini);
  ...
  flex-direction: column;
  align-items: flex-start;
  padding: var(--padding-sm-9) var(--padding-9xl) var(--padding-3xl-9)
  var(--padding-15xl-4);
  box-sizing: border-box;
  gap: var(--gap-sm-5);
  min-width: 106px;
...
.vector-parent3 {
  ...
  align-items: flex-start;
  justify-content: flex-start;
  padding: 0 var(--padding-12xs) 0 var(--padding-11xs-3);
}
.vector-parent3 {
  align-self: stretch;
  border-radius: var(--br-mini);
  background-color: var(--color-whitesmoke);
  flex-direction: column;
  padding: 15.2px var(--padding-xl) var(--padding-4xl-3) 30.6px;
  gap: var(--gap-2xs);
}
.frame-child4 {
  width: 141px;
...
.wrapper {
  ...
  align-items: flex-start;
  justify-content: flex-start;
  padding: 0 var(--padding-6xs) 0 var(--padding-10xs-9);
}
.vector-icon2 {
  width: 51.7px;
  height: 55.6px;
...
.vector-parent4 {
  ...
  display: flex;
  align-items: flex-start;
  padding: 15.2px var(--padding-25xl) var(--padding-3xl-6) 45.7px;
  gap: var(--gap-smi-4);
}
.frame-parent3 {
  height: 274.1px;
...
.div {
  ...
  align-items: flex-end;
  justify-content: flex-start;
  padding: var(--padding-4xs) var(--padding-24xl) var(--padding-301xl-2)
  var(--padding-21xl);
  gap: var(--gap-160xl-1);
  line-height: normal;
